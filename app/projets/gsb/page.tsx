        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <article className="prose prose-invert prose-blue max-w-none">
            ...
            <div className="my-12">
              <div className="bg-[#111] p-2 rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
                <img 
                  src={`${process.env.NEXT_PUBLIC_BASE_PATH}/gsb-network.png`} 
          ...
          <div className="mt-20 pt-10 border-t border-white/10">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <a href={`${process.env.NEXT_PUBLIC_BASE_PATH}/GSB_Archives.zip`} download className="flex items-center justify-between p-4 bg-white/5 hover:bg-white/10 rounded-xl border border-white/5 transition-colors group">
